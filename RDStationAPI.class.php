...
class RDStationAPI
{
     ...
     * @throws Exception
     */
    public function __construct($privateToken = null, $token = null, $isAsync = true)
    {
    ...
    protected function request($method = "POST", $url='', $data = array())
    {
        ...
        if (function_exists('exec') && extension_loaded('curl') && $this->isAsync) {
            $this->makeCurlRequest($method, $url, $data);
        } else {
    ...
    private function makeRequest($method, $url, $payload)
    {
